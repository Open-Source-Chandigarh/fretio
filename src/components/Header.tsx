            ...
            {user ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="relative h-9 w-9 rounded-full hover:bg-amber-50 transition-all duration-200 hover:scale-105"
                      >
                    ...
                    <DropdownMenuContent
                      className="w-56 rounded-xl shadow-xl bg-white/90 backdrop-blur-md"
                      align="end"
                    >
                      <DropdownMenuLabel>
                  ...
                  {profile?.verification_status === "verified" && (
                    <Button
                      variant="default"
                      size="sm"
                      className="bg-gradient-to-br from-yellow-400 to-amber-500 text-white shadow hover:shadow-md transition-all"
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant="default"
                  size="sm"
                  className="bg-yellow-100 text-amber-700 hover:bg-yellow-200 shadow-sm transition-all"
              ...
              {user ? (
                <>
                  ...
                  {profile?.verification_status === "verified" && (
                    <Button
                      variant="default"
                      size="sm"
                      className="w-full bg-gradient-to-br from-yellow-400 to-amber-500 text-white"
                      onClick={() => navigate("/create-product")}
                    >
                      Sell Item
                    </Button>
                ...
                <>
                  <Button
                    variant="default"
                    size="sm"
                    className="w-full bg-yellow-100 text-amber-700 hover:bg-yellow-200 shadow-sm transition-all"
                    onClick={() => navigate("/auth")}
                  >
                  ...
                  <Button
                    variant="default"
                    size="sm"
                    className="w-full bg-gradient-hero text-white shadow hover:shadow-md transition-all"
                    onClick={() => navigate("/auth")}
                  >
                    Sign Up
                  </Button>
